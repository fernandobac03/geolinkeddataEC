    ...
    function (e, t, n)
    {
        ...
        app.factory("Map", ["$http", function (e) {
				...
				estiloNeutral = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.05, 3], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "http://www.pngall.com/wp-content/uploads/2017/05/Map-Marker-Free-Download-PNG.png"})
                                });

				estiloPositivo = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.5, 1], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "https://i.ya-webdesign.com/images/vector-pointers-green-map-2.png"})
                                });
