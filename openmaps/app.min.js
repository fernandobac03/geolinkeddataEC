    ...
    function (e, t, n)
    {
        ...
        app.factory("Map", ["$http", function (e) {
				...
				estiloNeutral = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.5, 3], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "http://linkeddata.ec/openmaps/images/neutral.png"})
                                });

				estiloPositivo = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.5, 3], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "http://linkeddata.ec/openmaps/images/positivo.png"})
                                });
