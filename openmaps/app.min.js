                ...
                i = function (t) {
                    this.initialize = function () {
                        ...
                        var n = 'PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> '
                                ...
                                + ' SELECT DISTINCT ?label ?wkt ?sameAs '
                                + ' WHERE { ?a a <' + t + '> . '
                                + '         ?a rdfs:label ?label . '
                                + '         ?a geo:hasGeometry ?b . '
                                + '         ?b geo:asWKT ?wkt '
                        ...
                        l = function (e) {
                            this.initialize = function () {
                                ...
                                n.on("pointermove", function (e) {
                                    ...
                                    if (o) {
                                        r.setPosition(t);
                                        var i = $("div.popover:visible").length > 0, a = "Long: " + t[0] + "<br/> Lat: " + t[1] + (o.sameAs ? "<br/> dbpedia: <a target=\"black\" href=\"" + o.sameAs + "\">" + o.sameAs + "</a>" : ""), l = o.label;
