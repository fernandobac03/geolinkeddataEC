    ...
    function (e, t, n)
    {
        ...
        app.factory("Map", ["$http", function (e) {
				...
				estiloNeutral = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.5, 30], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "https://img.favpng.com/3/22/3/google-map-maker-klafs-computer-icons-google-maps-png-favpng-XEPap0vsqKDH9JKHpSt45Netf.jpg"})
                                });

				estiloPositivo = new ol.style.Style({
                                    image: new ol.style.Icon({
                                        anchor: [.5, 30], anchorXUnits: "fraction", anchorYUnits: "pixels", src: "https://cdn.imgbin.com/4/23/1/imgbin-google-maps-google-map-maker-drawing-pin-symbol-map-cBHEyPCpxhErVT3bh3ghVgmC4.jpg"})
                                });
                                ...
                                angular.forEach(r, function (e, n) {
                                    ...
                                    var g = f.getGeometry().getType();
                                    	"Point" == g && valor_polaridad ? ( valor_polaridad > 0 ? f.setStyle(estiloPositivo) : f.setStyle(estiloNeutral) ) : f.setStyle(a),
