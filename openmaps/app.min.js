                        ...
                        l = function (e) {
                            this.initialize = function () {
                                ...
                                angular.forEach(r, function (e, n) {
                                    ...
                                    f = s.isInt(p) && 4326 != p ? d.readFeature(c, {dataProjection: "EPSG:" + p, featureProjection: "EPSG:4326"}) : d.readFeature(c), f.label = l, f.sameAs = sa, f.idUriClass = t;
                                ...
                                n.on("pointermove", function (e) {
                                    ...
                                    if (o) {
                                        r.setPosition(t);
                                        var i = $("div.popover:visible").length > 0, a = "Long: " + t[0] + "<br/> Lat: " + t[1] + (o.sameAs ? "<br/> dbpedia: <a target=\"black\" href=\"" + o.sameAs + "\">" + o.sameAs + "</a>" : "")  + (o.polaridad ? "<br/> polaridad: " + o.polaridad : ""), l = o.label;
