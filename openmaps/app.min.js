        ...
        var o = null,
				...
				+ ' 	} '
                        ...
                        var n = 'PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> '
                                ...
                                + ' SELECT DISTINCT ?label ?wkt ?sameAs ?polaridad ?valor_polaridad ?tipo_lugar ?total_opiniones ?provincia ?canton ?localidad'
                                + ' WHERE { '
				+ '	    ?a a <' + t + '> . '
                                + '         ?a rdfs:label ?label . '
                                + '         ?a geo:hasGeometry ?b . '
 				...
 				+ '         OPTIONAL { ?a geoec:provincia ?provincia  } .'
				+ '         OPTIONAL { ?a geoec:canton ?canton  } .'
				+ '         OPTIONAL { ?a geoec:localidad ?localidad  } .'
                                + '} LIMIT ' + e.config.endpoint.maxResults;
        ...
        app.factory("Map", ["$http", function (e) {
                ...
                var t, n = null, o = new ol.source.Vector({}),
                        ...
                        l = function (e) {
                            this.initialize = function () {
                                t = e, 
				estiloNegativo = new ol.style.Style({
				...
				estiloPositivo = new ol.style.Style({
					    ...
					    provincia = e.provincia ? e.provincia.value : null,
					    canton = e.canton ? e.canton.value : null,
					    localidad = e.localidad ? e.localidad.value : null,
                                    ...
                                    f = s.isInt(p) && 4326 != p ? d.readFeature(c, {dataProjection: "EPSG:" + p, featureProjection: "EPSG:4326"}) : d.readFeature(c), f.label = l, f.sameAs = sa, f.polaridad = polaridad, f.valor_polaridad = valor_polaridad, f.tipo_lugar = tipo_lugar, f.total_opiniones = total_opiniones, f.provincia = provincia, f.canton = canton, f.localidad = localidad, f.idUriClass = t;
				 	...
				 	"MultiPolygon" == g && f.setStyle(b), o.addFeature(f)
							...
							+ (o.total_opiniones ? "<br/> Número de opiniones analizadas: " + o.total_opiniones : "")
							+ (o.polaridad ? "<br/> Polaridad de opiniones: " + o.polaridad : "")  
							+ (o.valor_polaridad ? "<br/> Valor detectado de la polaridad: " + o.valor_polaridad : "")  
							+ (o.provincia ? "<br/> Provincia: " + o.provincia : "")  
							+ (o.canton ? "<br/> Canton: " + o.canton : "")  
							+ (o.localidad ? "<br/> Localidad: " + o.localidad : "")  
							,l = o.label;
...
ssh-rsa  
